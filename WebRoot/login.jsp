...
<body>
	...
	<div class="reg jumbotron">
		...
		<form class="form-horizontal clear" role="form" name="loginModel" action="./user/login" method="post" >
			...
			<div class="input-group uname">
				<span class="input-group-addon logintxt">请输入密码</span>
		...
		<form class="form-horizontal clear" role="form" name="loginGrapher" action="./user/login" method="post" >
			<div class="input-group uname">
				<span class="input-group-addon logintxt">用户名</span> 
				<input type="text" class="form-control" name="user.name">
			</div>
